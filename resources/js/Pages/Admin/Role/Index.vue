                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
                                ...
                                <td class="py-4 px-6 w-45" width="250px" 
                                    ...
                                    <div type="justify-start lg:justify-end" no-wrap>
                                        <!--
                                        <button class="ml-4 bg-green-500 px-2 py-1 rounded text-white cursor-pointer" v-if="can.edit">Szerkesztés</button>
                                        <button class="ml-4 bg-red-500 px-2 py-1 rounded text-white cursor-pointer" v-if="can.delete">Törlés</button>
                                        -->
                                    </div>
                                </td>
                            </tr>
