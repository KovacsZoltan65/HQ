                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="flex bg-gray-800 justify-between items=center p-5">
                        <div class="flex space-x-2 items-center text-white">
                            Hozzászólás beállításai oldal! Itt listázhatja, létrehozhatja, frissítheti vagy törölheti a bejegyzést!
                        </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th class="py-3 px-6" scope="col">Cím</th>
                                <th class="py-3 px-6" scope="col">Leírás</th>
                                <th class="py-3 px-6" scope="col" 
                                    v-if="can.edit || can.delete">Műveletek</th>
                            </tr>
                        </thead>
                        <tbody>
