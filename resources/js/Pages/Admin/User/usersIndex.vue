                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr v-for="user in state.Users">
                                    ...
                                    <td class="px-4 py-2 border" v-show="state.columns.title.is_visible">{{ user.title }}</td>
                                    <td class="px-4 py-2 border" v-show="state.columns.author.is_visible">{{ user.author }}</td>
                                    <td class="px-4 py-2 border" v-show="state.columns.image.is_visible">{{ user.image }}</td>
